...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F7F5] text-[#171717] flex flex-col antialiased">
      {/* Top Header */}
      <Header
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 max-w-[1500px] w-full pb-24 lg:pb-8">
          {activeTab === 'dashboard' && (
            <DashboardView
