...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex flex-col w-[230px] shrink-0 bg-[#F7F7F5] border-r border-[#E5E5E2] min-h-[calc(100vh-56px)] select-none">
        {/* Navigation list */}
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-[#E5E5E2] px-2 py-1.5 flex items-center justify-around">
        {[
          { id: 'dashboard' as NavTab, label: 'Overview', icon: LayoutDashboard },
          { id: 'waste' as NavTab, label: 'Waste', icon: Trash2 },
          { id: 'forecast' as NavTab, label: 'Forecast', icon: TrendingUp },
