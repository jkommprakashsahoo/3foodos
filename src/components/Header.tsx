...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 h-14 bg-[#F7F7F5] border-b border-[#E5E5E2] px-4 lg:px-6 flex items-center justify-between">
      {/* Left: Brand + Divider + Page Title */}
      <div className="flex items-center gap-4">
        {/* Brand */}
        <div className="flex items-center gap-2">
          <span className="w-4 h-4 rounded-sm bg-[#1E3A2B] inline-block"></span>
          <span className="font-semibold text-sm tracking-tight text-[#171717]">FoodWise</span>
        </div>
